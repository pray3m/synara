// FILE: _chat.settings.lazy.tsx
// Purpose: Lazy-loaded settings route component — only fetched when the user navigates to /settings.
// Layer: Route screen (lazy chunk)
// Exports: Lazy route component for `/settings`
...
export const Route = createLazyFileRoute("/_chat/settings")({
